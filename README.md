...
result of §5.1: the quasi-statically optimised design is still unbuildable at 4000 rpm.
...
from what is solved — `exlink diagram` regenerates them. §4.8 reads them.
...
| [5. Results](docs/results.md) | the five principal findings |
...
| [Appendix C. Supporting measurements](docs/supporting.md) | coupling strength, derivatives, decomposition, reference designs |
...
the two parametrisation figures of §3.1 and the two design vectors below.
